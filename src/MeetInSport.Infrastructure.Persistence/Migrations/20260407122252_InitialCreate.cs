        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KvkkAcceptedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationInMinutes = table.Column<decimal>(type: "numeric", nullable: false),
                    PackagePrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Requirements = table.Column<string[]>(type: "text[]", nullable: false),
                    LocationType = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    LessonModel = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonPackages_Coaches_CoachId",
                        column: x => x.CoachId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_LessonPackages_PackageId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System Mamager", "Admin" },
                    { 2, "Can Create packages and give lessons", "Coach" },
                    { 3, "Can book lessons and view their progress", "Student" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonPackages_CoachId_PackageName",
                table: "LessonPackages",
                columns: new[] { "CoachId", "PackageName" },
                unique: true);
